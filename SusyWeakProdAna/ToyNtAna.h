...
class ToyNtAna : public TSelector {
 public :
  ...
  RunEventMap m_eventListDuplicate; //Checks for duplicate run/event
   ...
   Int_t           nFJets;
   Int_t           nOJets;
   Bool_t          j_isC20[14];   //[nJets]
   Bool_t          j_isB20[14];   //[nJets]
   Bool_t          j_isF30[14];   //[nJets]
   Bool_t          j_isOJ[14];   //[nJets]
   Float_t         j_pt[14];   //[nJets]
   Float_t         j_eta[14];   //[nJets]
   Float_t         j_phi[14];   //[nJets]
   Float_t         j_e[14];   //[nJets]
   Float_t         j_jvf[14];   //[nJets]
   Float_t         j_mv1[14];   //[nJets]
   Bool_t          j_isTruth[14];   //[nJets]
   Int_t           j_label[14];   //[nJets]
   Bool_t          j_isRecoil[14];   //[nJets]
   Bool_t          j_isSublead[14];   //[nJets]
   Float_t         met;
   Float_t         met_phi;
   Float_t         metrel;
   Float_t         met_refEle;
   ...
   Float_t         mT2jj;
   Float_t         sphericity;
   Float_t         sphericityTrans;
   Float_t         llAcoplanarity;
   Float_t         jjAcoplanarity;
   Bool_t          topTag;
   Float_t         mEff;
   Float_t         ST;
   Float_t         mjj;
   ...
   TBranch        *b_sphericityTrans;   //!
   TBranch        *b_llAcoplanarity;   //!
   TBranch        *b_jjAcoplanarity;   //!
   TBranch        *b_topTag;   //!
   TBranch        *b_mEff;   //!
   TBranch        *b_ST;   //!
   TBranch        *b_mjj;   //!
...
void ToyNtAna::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("mll_collApprox", &mll_collApprox, &b_mll_collApprox);
   ...
   fChain->SetBranchAddress("j_isC20", j_isC20, &b_j_isC20);
   ...
   fChain->SetBranchAddress("mWWT", &mWWT, &b_mWWT);
   ...
   fChain->SetBranchAddress("mT2jj", &mT2jj, &b_mT2jj);
   fChain->SetBranchAddress("sphericity", &sphericity, &b_sphericity);
   fChain->SetBranchAddress("sphericityTrans", &sphericityTrans, &b_sphericityTrans);
   fChain->SetBranchAddress("llAcoplanarity", &llAcoplanarity, &b_llAcoplanarity);
   fChain->SetBranchAddress("jjAcoplanarity", &jjAcoplanarity, &b_jjAcoplanarity);
   fChain->SetBranchAddress("topTag", &topTag, &b_topTag);
   fChain->SetBranchAddress("mEff", &mEff, &b_mEff);
   fChain->SetBranchAddress("ST", &ST, &b_ST);
   fChain->SetBranchAddress("mjj", &mjj, &b_mjj);
   fChain->SetBranchAddress("mct", &mct, &b_mct);
   fChain->SetBranchAddress("mctPerp", &mctPerp, &b_mctPerp);
   fChain->SetBranchAddress("mctPara", &mctPara, &b_mctPara);
   fChain->SetBranchAddress("JZBjets", &JZBjets, &b_JZBjets);
   fChain->SetBranchAddress("JZBmet", &JZBmet, &b_JZBmet);

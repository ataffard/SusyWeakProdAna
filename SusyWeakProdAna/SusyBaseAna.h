...
//Susy Fake Matrix - New Aug 13/2014
...
class SusyBaseAna: public SusySelection
{
 ...
 protected:
  ...
  sf::DileptonMatrixMethod m_matrix_method;
  sf::DileptonMatrixMethod m_matrix_methodWH;
  sf::DileptonMatrixMethod m_matrix_methodLFV;

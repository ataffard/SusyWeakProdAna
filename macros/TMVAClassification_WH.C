 ...
 *    root -l ./TMVAClassification.C\(\"BDTG\"\)                       *
 *                                                                                *
...
/*
  mode=1 wA_noslep_hadW, mass point [300,50]
*/
...
void TMVAClassification_WH( TString myMethodList = "" )
{
   ...
   */
   ...
   TString fname_sig;
   fname_sig = string(getenv("HISTOANA")) + "/SusyAna/" + ver;
   fname_sig += "toyNt_" + sSelection[mode-1] + "_" + toySkim + "_rlep.root"; //wA_noslep_300_50
